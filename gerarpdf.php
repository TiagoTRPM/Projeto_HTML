<?php  
		...
		$pdf->Cell(50,20,Nome,0,0,'L');
		$pdf->setFont('helvetica','',12);
		$pdf->Cell(70,20,$nome,0,1,'L');
		//endereço
		$pdf->SetFont('helvetica','B',12);
		$pdf->Cell(60,20,utf8_decode(Endereço),0,0,'L');
		$pdf->setFont('helvetica','',12);
		$pdf->Cell(70,20,utf8_decode($endereço),0,1,'L');
		//telefone
		$pdf->SetFont('helvetica','B',12);
		$pdf->Cell(40,20,Telefone,0,0,'L');
		$pdf->setFont('helvetica','',12);
		$pdf->Cell(70,20,$telefone,0,1,'C');
		//idade
		$pdf->SetFont('helvetica','B',12);
		$pdf->Cell(30,20,Idade,0,0,'L');
		$pdf->setFont('helvetica','',12);
		$pdf->Cell(70,20,$idade,0,1,'C');
		//data nascimento
		$pdf->SetFont('helvetica','B',12);
		$pdf->Cell(130,20,'Data de nascimento',0,0,'L');
		$pdf->setFont('helvetica','',12);
		$pdf->Cell(70,20,$dat_nasc,8,1,'C');
		//estado civil
		$pdf->SetFont('helvetica','B',12);
		$pdf->Cell(95,20,'Estado civil',0,0,'L');
		$pdf->setFont('helvetica','',12);
		$pdf->Cell(90,20,$est_civil,5,1,'L');
		//Escolaridade
		$pdf->SetFont('helvetica','B',12);
		$pdf->Cell(90,20,utf8_decode(Escolaridade),0,0,'L');
		$pdf->setFont('helvetica','',12);
